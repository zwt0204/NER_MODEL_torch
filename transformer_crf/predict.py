...
class NerPredicter:
    def __init__(self, vocab_file: str = 'vocab.json', model_path: str = 'models/Transformer/ner.pt'):
...
def main():
    ...
    parser.add_argument('--model-path', default='models/Transformer/ner.pt')
    parser.add_argument('--text', default='高勇，男，中国国籍，无境外居留权')
