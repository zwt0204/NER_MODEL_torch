...
def main():
    run(["-m", "BILSTM_CNN_CRF.generate_fake_data"])
    run([
        "-m", "BILSTM_CNN_CRF.train",
    ...
    model_path = os.path.join(ROOT, "BILSTM_CNN_CRF/demo_data/model/ner.pt")
