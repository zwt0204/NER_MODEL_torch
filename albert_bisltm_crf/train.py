...
class NerTrainner:
    def __init__(self, vocab_file: str = 'vocab.json', model_dir: str = 'models/AlbertBiLSTMCRF'):
...
def main():
    ...
    parser.add_argument('--model-dir', default='models/AlbertBiLSTMCRF')
    ...
    tmp_dir = tempfile.mkdtemp(prefix='ner_albert_bilstm_crf_train_')
